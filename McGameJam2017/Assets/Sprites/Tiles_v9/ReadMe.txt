All textures in "data/ses" folder by S.E.S

Copyright: 2014, S.E.S
License: CC-BY-SA-3.0

Please, visit <http://creativecommons.org/licenses/by-sa/3.0> for more information about the license. 


USAGE:

	Install "data" folder to "redeclipse" folder.
	Use "package.cfg" to add texture to your maps.
...
NOTE:
	...
	You can deleted this file from your project.
	Also, You can deleted from your project file "ReadMe.txt" from textures folder,
	provided that authorship and license will be present in any other file or files of your project. 

	My English language is very bad, sorry...


Textures License text:
